    ...
    <section class="content-wrapper">
        <div class="content-container container">
            <div class="breadcrum-container">
                <ul>
                    <li><a href="index.product" title="Home">主页</a></li>
                    <li>${p.name}</li>
                </ul>
            </div>
            <div class="main">
                    ...
                    <div class="product-essential">
                        <div class="product-img-box">
                            <p class="product-image-zoom">
                                <img src="<%=path%>${p.imgpath }" alt="${p.name }" title="Image" />
                            </p>
                            <p>点击查看大图</p>
                            <div class="img-slider">
                                ...
                                <ul id="moreView">
                                    <li><a class="ajax" href="images/view_img.png"><img
                                            src="<%=path%>${p.imgpath }" alt="" title="" /></a></li>
                                    <li><a class="ajax" href="images/view_img.png"><img
                        ...
                        <div class="product-shop">
                            ...
                            <div class="price-box">
                                <span class="price">${p.normalprice }</span> <span class="availability">有货</span>
                            </div>
                            ...
                            <div class="add-to-cart-box">
                                ...
                                <button class="form-button" title="添加购物车" onclick="location.href='cart.html'">
                                    <span>添加购物车</span>
                                </button>
                                <ul class="add-to-box">
